    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form" method="POST" enctype="multipart/form-data" action="{{URL::to('/')}}/admin/artists/store">
                    @csrf
                    ...
                    <div class="form-group m-t-40 row">
                        <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <input class="form-control" value="{{old('artist_name')}}" type="text" name="artist_name" id="example-text-input" placeholder="Artist Name">
                                @error('artist_name')
                    ...
                    <div class="form-group m-t-20 row">
                        ...
                        <div class="col-12">
                            <textarea class="form-control" rows="3" type="text" name="artist_description" id="example-text-input" placeholder="Artist Description">{{old('artist_description')}}</textarea>
