            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="d-flex no-block align-items-center">
                        ...
                        <div class="ml-auto">
                            <h2 class="counter text-primary">{{$noOfUsers}}</h2>
                        </div>
                    </div>
                </div>
                <div class="col-12">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="d-flex no-block align-items-center">
                        <div>
                            <h3><i class="ti-music-alt"></i></h3>
                            <p class="text-muted">Total Songs</p>
                        </div>
                        <div class="ml-auto">
                            <h2 class="counter text-cyan">{{$noOfSongs}}</h2>
                        </div>
                    </div>
                </div>
                <div class="col-12">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="d-flex no-block align-items-center">
                        <div>
                            <h3><i class="fas fa-guitar"></i></h3>
                            <p class="text-muted">TOTAL ARTISTS</p>
                        </div>
                        <div class="ml-auto">
                            <h2 class="counter text-purple">{{$noOfArtists}}</h2>
                        </div>
                    </div>
                </div>
                <div class="col-12">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="d-flex no-block align-items-center">
                        <div>
                            <h3><i class="fas fa-compact-disc"></i></h3>
                            <p class="text-muted">TOTAL ALBUMS</p>
                        </div>
                        <div class="ml-auto">
                            <h2 class="counter text-success">{{$noOfAlbums}}</h2>
                        </div>
                    </div>
                </div>
                <div class="col-12">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    ...
                                    <div class="d-flex no-block">
                                        <span><img src="{{URL::to('/')}}/public/assets/images/users/1.jpg" alt="user" width="50" class="img-circle"></span>
                                        <span class="m-l-10">
                                ...
                                <div class="carousel-item">
                                    <h4 class="cmin-height">My Acting blown <span class="font-medium">Your Mind</span> and you also <br/>laugh at the moment</h4>
                                    <div class="d-flex no-block">
                                        <span><img src="{{URL::to('/')}}/public/assets/images/users/2.jpg" alt="user" width="50" class="img-circle"></span>
                                        <span class="m-l-10">
                                            <h4 class="text-white m-b-0">Govinda</h4>
                                            <p class="text-white">Actor</p>
                                        </span>
                                ...
                                <div class="carousel-item">
                                    <h4 class="cmin-height">My Acting blown <span class="font-medium">Your Mind</span> and you also <br/>laugh at the moment</h4>
                                    <div class="d-flex no-block">
                                        <span><img src="{{URL::to('/')}}/public/assets/images/users/3.jpg" alt="user" width="50" class="img-circle"></span>
                                        <span class="m-l-10">
                                            <h4 class="text-white m-b-0">Govinda</h4>
                                            <p class="text-white">Actor</p>
                                        </span>
        ...
        <div class="card">
            ...
            <div class="comment-widgets" id="comment" style="height: 630px;position: relative;">
                ...
                <div class="d-flex no-block comment-row">
                    <div class="p-2"><span class="round"><img src="{{URL::to('/')}}/public/assets/images/users/1.jpg" alt="user" width="50"></span></div>
                ...
                <div class="d-flex no-block comment-row border-top">
                    <div class="p-2"><span class="round"><img src="{{URL::to('/')}}/public/assets/images/users/2.jpg" alt="user" width="50"></span></div>
                 ...
                 Comment Row 
                <div class="d-flex no-block comment-row border-top">
                    <div class="p-2"><span class="round"><img src="{{URL::to('/')}}/public/assets/images/users/3.jpg" alt="user" width="50"></span></div>
                    <div class="comment-text w-100">
                 ...
                 Comment Row 
                <div class="d-flex no-block comment-row border-top">
                    <div class="p-2"><span class="round"><img src="{{URL::to('/')}}/public/assets/images/users/4.jpg" alt="user" width="50"></span></div>
                    <div class="comment-text active w-100">
                ...
                <div class="to-do-widget m-t-20" id="todo" style="height: 400px;position: relative;">
                    ...
                    <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                        <li class="list-group-item" data-role="task">
                            ...
                            <ul class="assignedto">
                                <li><img src="{{URL::to('/')}}/public/assets/images/users/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                                <li><img src="{{URL::to('/')}}/public/assets/images/users/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                <li><img src="{{URL::to('/')}}/public/assets/images/users/3.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                <li><img src="{{URL::to('/')}}/public/assets/images/users/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                            </ul>
                        </li>
                        <li class="list-group-item" data-role="task">
                            <div class="custom-control custom-checkbox">
                ...
                <div class="message-box" id="msg" style="height: 430px;position: relative;">
                    <div class="message-widget message-scroll">
                        ...
                        <a href="javascript:void(0)">
                         ...
                         Message 
                        <a href="javascript:void(0)">
                            <div class="user-img"> <img src="{{URL::to('/')}}/public/assets/images/users/2.jpg" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                            <div class="mail-contnet">
                        ...
                        <a href="javascript:void(0)">
                         ...
                         Message 
                        <a href="javascript:void(0)">
                            <div class="user-img"> <img src="{{URL::to('/')}}/public/assets/images/users/4.jpg" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                            <div class="mail-contnet">
            ...
            <div class="card-body">
                ...
                <div class="chat-box" id="chat" style="height: 327px;position: relative;">
                    ...
                    <ul class="chat-list">
                        chat Row 
                        <li>
                            <div class="chat-img"><img src="{{URL::to('/')}}/public/assets/images/users/1.jpg" alt="user"></div>
                        ...
                        chat Row 
                        <li>
                            <div class="chat-img"><img src="{{URL::to('/')}}/public/assets/images/users/2.jpg" alt="user"></div>
                            <div class="chat-content">
                                <h5>Bianca Doe</h5>
                        ...
                        chat Row 
                        <li>
                            <div class="chat-img"><img src="{{URL::to('/')}}/public/assets/images/users/3.jpg" alt="user"></div>
                            <div class="chat-content">
    ...
    <div class="slimscrollright">
        ...
        <div class="r-panel-body">
            ...
            <ul class="m-t-20 chatonline">
                ...
                <li>
                    <a href="javascript:void(0)"><img src="{{URL::to('/')}}/public/assets/images/users/1.jpg" alt="user-img" class="img-circle"> <span>Varun Dhavan <small class="text-success">online</small></span></a>
                </li>
                <li>
                    <a href="javascript:void(0)"><img src="{{URL::to('/')}}/public/assets/images/users/2.jpg" alt="user-img" class="img-circle"> <span>Genelia Deshmukh <small class="text-warning">Away</small></span></a>
                </li>
                <li>
                    <a href="javascript:void(0)"><img src="{{URL::to('/')}}/public/assets/images/users/3.jpg" alt="user-img" class="img-circle"> <span>Ritesh Deshmukh <small class="text-danger">Busy</small></span></a>
                </li>
                <li>
                    <a href="javascript:void(0)"><img src="{{URL::to('/')}}/public/assets/images/users/4.jpg" alt="user-img" class="img-circle"> <span>Arijit Sinh <small class="text-muted">Offline</small></span></a>
                </li>
                <li>
                    <a href="javascript:void(0)"><img src="{{URL::to('/')}}/public/assets/images/users/5.jpg" alt="user-img" class="img-circle"> <span>Govinda Star <small class="text-success">online</small></span></a>
                </li>
                <li>
                    <a href="javascript:void(0)"><img src="{{URL::to('/')}}/public/assets/images/users/6.jpg" alt="user-img" class="img-circle"> <span>John Abraham<small class="text-success">online</small></span></a>
                </li>
                <li>
                    <a href="javascript:void(0)"><img src="{{URL::to('/')}}/public/assets/images/users/7.jpg" alt="user-img" class="img-circle"> <span>Hritik Roshan<small class="text-success">online</small></span></a>
                </li>
                <li>
                    <a href="javascript:void(0)"><img src="{{URL::to('/')}}/public/assets/images/users/8.jpg" alt="user-img" class="img-circle"> <span>Pwandeep rajan <small class="text-success">online</small></span></a>
                </li>
            </ul>
        </div>
    </div>
