    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form" method="POST" action="{{URL::to('/')}}/admin/categories/update/<?php echo $categoryDetail->id;?>">
                    @csrf
                    ...
                    <div class="form-group m-t-40 row">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text" name="category_name" value="<?php echo $categoryDetail->category_name;?>" id="example-text-input" placeholder="Category Name">
                            @error('category_name')
